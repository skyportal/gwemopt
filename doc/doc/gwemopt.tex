...
\affil{Carleton College, Northfield, MN 55057, USA}
\affil{Artemis, Université Côte d’Azur, CNRS, Observatoire Côte d’Azur, CS 34229, Nice cedex 4, France}
...
\begin{figure*}
    ...
    \caption{Example outputs of different time allocation algorithms. On the top left is the tiles coverage with the PEM algorithm. On the top right is the tiles coverage with the Powerlaw algorithm. On the bottom is the tiles coverage with the WAW algorithm. All of them use MOC tiling and greedy scheduling.}
    \label{fig:timealloc}
\end{figure*}
