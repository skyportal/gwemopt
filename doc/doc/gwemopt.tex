...
\begin{figure}[H]
    \hspace*{-0.5cm}
    \centering
    \includegraphics[width=4in]{tiling_moc.pdf}
...
\begin{figure}[H]
    \hspace*{-0.5cm}
    \centering
    \includegraphics[width=4in]{tiling_ranked.pdf}
...
\begin{figure}[H]
    \hspace*{-0.5cm}
    \centering
    \includegraphics[width=4in]{tiling_hierarchical.pdf}
...
\begin{figure}[H]
    \hspace*{-0.5cm}
    \centering
    \includegraphics[width=4in]{tiling_greedy.pdf}
