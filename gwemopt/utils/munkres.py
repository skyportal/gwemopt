# Adopted from https://github.com/bmc/munkres and an unmerged PR https://github.com/bmc/munkres/pull/43 that deals with an unsolvable matrix
        ...
        def _check_one_dimension_solvability(matrix):
            ...
            for row in matrix:
                ...
                indices = [
                    ...
                    if not isinstance(val, type(DISALLOWED))
                ]
